...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      dispatch(authFailure(err.response?.data?.detail || err.message || 'Sign up failed'));
    }
  };
  ...
  return (
    ...
    >
      <Card sx={{ width: '100%', maxWidth: 440, borderRadius: 2, boxShadow: '0 20px 60px rgba(0,0,0,0.4)' }}>
